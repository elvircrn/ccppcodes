...
public:
  ...
  Izraz(const string &operacija_1, const string &operacija_2, Izraz operand_1, 
    Izraz operand_2, Izraz operand_3);
  ~Izraz();
  Izraz(const Izraz &e);
...
class CvorTernarni : public CvorApstraktni {
  ...
  void Ispisi(ostream &cout) const { 
    cout << "(" << operand_1 << operacija_1 << operand_2 << operacija_2
      << operand_3 << ")";
  }
  CvorTernarni(const string &operacija_1, const string &operacija_2,
    Izraz operand_1, Izraz operand_2, Izraz operand_3) : 
    operacija_1(operacija_1), operacija_2(operacija_2), operand_1(operand_1), 
...
Izraz::Izraz(const string &operacija_1, const string &operacija_2, 
  Izraz operand_1, Izraz operand_2, Izraz operand_3) : 
  korijen(new CvorTernarni(operacija_1, operacija_2, operand_1, operand_2, 
  operand_3)) {}
...
int CvorTernarni::Izracunaj() const {
...
int main() {
  Izraz e(Izraz("?", ":", Izraz("+", 3, 2), Izraz("*", 2, 3), Izraz("/", 4,2)));
  cout << e << " = " << e.Izracunaj() << endl;
  e = Izraz("?", ":", Izraz("-", 3, 3), Izraz("*", 2, 3), Izraz("/", 4, 2));
  cout << e << " = " << e.Izracunaj() << endl;
  return 0;
}
