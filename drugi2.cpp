...
int main () {
    ...
    while (hh.val == maxtaxi && !T.empty()) {
        T.pop();
        if (ddd >= 1) printf (",");
        if (ddd == 0 ) printf ("%s", names [hh.ind]);
        else if (ddd ) printf (" %s", names [hh.ind]);
        //T.pop();
        hh = T.top();
        ddd++;
    }
    ...
    ddd = 0;
    while (h.val == maxpizza && !P.empty()) {
        P.pop();
        if (ddd >= 1) printf (",");
        if (ddd == 0) printf ("%s", names [h.ind]);
        else if (ddd) printf (" %s", names [h.ind]);
        //P.pop();
        h = P.top();
        ddd++;
    }
    ...
    ddd = 0;
    while (hhh.val == maxgirl && !G.empty()) {
        G.pop();
        if (ddd >= 1) printf (",");
        if (ddd == 0) printf ("%s", names [hhh.ind]);
        else if (ddd) printf (" %s", names [hhh.ind]);
        //G.pop();
hhh = G.top();
        ddd++;
    }
